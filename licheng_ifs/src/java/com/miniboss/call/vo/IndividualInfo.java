...
public class IndividualInfo
{
    ...
    private IndividualLookUpRequest lookUpRequset;    /* 返回请求信息*/
    private CmngCustominfo customerInfo;                  /* 用户基本信息 done*/
    private StbOrderInfo stbOrderInfos;             /* 机顶盒购买交易信息列表 No*/
    private StbBillInfo stbBillInfos;               /* 机顶盒购买帐单信息列表 No*/
    private StbTakeInfo stbTakeInfos;               /* 机顶盒过户信息列表 todo */
    private StbReturnInfo stbReturnInfos;           /* 机顶盒退货信息列表 todo*/
    private StbChangeInfo stbChangeInfos;           /* 换机信息列表 todo*/
    private StbSignUpInfo stbSignUpInfos;           /* 机顶盒开户信息列表 done*/
    private StbSignOffInfo stbSignOffInfos;         /* 机顶盒消户信息列表 todo*/
    private StbAddrMoveInfo stbAddrMoveInfos;       /* 机顶盒移机信息列表 No*/
    private SubscriptionInfo subscriptionInfos;     /* 收视服务信息列表 done*/
    private SubscripBillInfo subscripBillInfos;     /* 收视服务帐单信息列表 done*/
    private VodInfo vodInfos;                       /* VOD 服务信息列表 No*/
    private VodBillInfo vodBillInfos;               /* VOD 帐单信息列表 No*/
    private PpvInfo ppvInfos;                       /* PPV 服务信息列表 No*/
    private PpvBillInfo ppvBillInfos;               /* PPV 帐单信息列表 No*/
    private SpecialBillInfo specialBillInfos;       /* 特殊交费帐单信息列表 No*/
    private SpecialRefundInfo specialRefundInfos;   /* 特殊退款帐单信息列表 No*/
    private PayInfo payInfos;                       /* 交费交易信息列表 done*/
    private RefundInfo refundInfos;                 /* 退款交易信息列表 No*/
    private DepositInfo depositInfos;               /* 存款交易信息列表 No*/
    private WithdrawInfo withdrawInfos;             /* 取款交易信息信息列表 No*/
    private UnpaidSheetInfo unpaidSheetInfos;       /* 未交费单据信息列表 No*/
    private BalanceInfo balanceInfos;               /* 内部帐户余额信息列表 done*/
    private TeamSubscripInfo teamSubscripInfos;     /* 集团组的收视信息列表 No*/
    private SubscribeProductInfo subscribeProductInfos; /* 可订购收视产品信息列表 done*/
