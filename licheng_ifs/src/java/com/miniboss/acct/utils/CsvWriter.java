...
public class CsvWriter {
	...
	/**
	 * Creates a   object using a Writer
	 * to write data to.
	 * 
	 * @param outputStream
	...
	public CsvWriter(Writer outputStream, char delimiter) {
		...
		userSettings.Delimiter = delimiter;
		userSettings.RecordDelimiter = Letters.LF;
		initialized = true;
	}
    ...
    public CsvWriter(Writer outputStream) {
		...
		this.outputStream = new PrintWriter(outputStream);
		userSettings.Delimiter = Letters.TAB;
		userSettings.RecordDelimiter = Letters.LF;
		initialized = true;
	}

	/**
	 * Creates a   object using an
	...
	public void write(String content, boolean preserveSpaces)
        ...
        outputStream.write(Letters.COMMA);
		firstColumn = false;
	}
